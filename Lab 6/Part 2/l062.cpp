 ...
 * @para
 */
void identifyCoins(Grid &gr, vector<Circle> &finalCircles, int penny, int nickel, int quarter, int dollar, int halfdollar, vector<int> &coinTypes){
    ...
    for(size_t idx=0; idx < finalCircles.size(); idx++){
        ...
        */
        ...
        //if radius is within 10% of nickel radius:
            ...
            if(abs(radius-quarter) < 0.11*quarter){
...
void part2(const int &argc, char **&argv)
{
    ...
    identifyCoins(*gr,finalCircles,87,100,115,132,141,coinTypes);
