...
public:
    ...
    void voteAlongLine(int x, int y, double angle){
        ...
        if(abs(abs(angle)-90) < ERROR){ // if vertical line
            ...
            double yx0 = slope * (-1.0 * dblx) + dbly; //x=0
            double yx1 = slope * (1.0 - dblx) + dbly; //x=1
            double xy0 = -dbly/slope + dblx; //y=0
            double xy1 = (1.0 - dbly)/slope + dblx; //y=1
