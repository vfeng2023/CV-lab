 ...
 * @file l052.cpp
 * @author Vivian Feng
 * @brief Lab 6, Part 1 Coin Detection
 * @version 5.3
 * @date 2023-1-20
 *
...
public:
    ...
    bool setPixel(int r, int c, int red, int green, int blue)
    {   
        if(r >= 0 && r < height && c >= 0 && c < width){
    ...
    bool drawPixel(int x, int y, int red, int green, int blue){
        bool outcome = setPixel(y,x,red,green,blue);
        return outcome;
    }
...
public:
    ...
    bool drawPixel(IntegerPoint &p1)
    {
