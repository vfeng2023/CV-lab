...
public:
    ...
    */
    Triangle()
    {   int upper = 32767;
        p1 = new DoublePoint(double(rand()%upper) / (upper+1), double(rand()%upper) / (upper+1));
        p2 = new DoublePoint(double(rand()%upper) / (upper+1), double(rand()%upper) / (upper+1));
        p3 = new DoublePoint(double(rand()%upper) / (upper+1), double(rand()%upper) / (upper+1));
    ...
    */
    ...
    /*
        Returns the incenter of triangle
    */
    Circle findInCenter()
    {
