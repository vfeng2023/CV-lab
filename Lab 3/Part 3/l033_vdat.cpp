...
double part2()
{
    ...
    // stream << "Time taken: " << duration.count() << " seconds "<<endl;
...
//PART 3
MergeReturnObj zipperMerge3(vector<DoublePoint> &points, int start, int mid, int end)
{
    double minDist = DBL_MAX;
    int mindp1 = 0;
    int mindp2 = 0;
...
double part3()
{
    ...
    // stream << "Time taken: " << seconds.count() << "seconds "<<endl;
    // // double distance = mergeRet.getDistance();
    // DoublePoint dp1 = mergeRet.getPoint1();
    // DoublePoint dp2 = mergeRet.getPoint2();
...
{   
    ...
    cout << "Part 2 average runtime (Seconds): "<<p2avg << "\n";
    results << "Part 2 average runtime (Seconds): "<<p2avg << "\n";
    
    cout << "Part 3 average runtime(seconds): " << p3avg << endl;
    results << "Part 3 average runtime(seconds): " << p3avg << endl;
